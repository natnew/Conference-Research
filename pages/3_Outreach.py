...
templates = {
    ...
    "Custom Example": "Connect prior to the conference at the [Conference].\n\nDear [Name],\n\nI hope this message finds you well. I’m writing to ask if we could arrange to meet during the [Conference] conference this [Month]? I’ll be in [City] and would love to offer you a coffee or to meet in the Exhibitors’ Hall for a quick discussion about a new textbook idea.\n\nI am the [Your Title] here at [Your Company] and would find it invaluable to have an opportunity to discuss your teaching of (and research interests in) [Subject]. I appreciate a textbook may (or may not…) be something you have considered working on in the near future, but I’d also love a quick, open and exploratory discussion about texts, your experience using existing books, and an idea I have for a new textbook in a little more detail.\n\nI’d be delighted if we could meet at the [Your Company] stand during [Conference]. Looking at my diary, I could meet between [Time Range] on any day during the conference: [Dates]. I’m also available between [Additional Time Range] on [Additional Date]. I hope we might have chance to meet at the [Conference], and look forward to hearing from you.\n\nWith best wishes,\n[Your Name]"
}
